        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                     <div class="con-text">
                        <h2 class="page-title">{{$group_sp->Ten_Group}}</h2>
                        <p><a href="{{url('./')}}">Trang chủ</a> | {{$group_sp->Ten_Group}}</p>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="re-shop ">
                                        <div class="shop6 ">
                                            ...
                                            <select onchange="location.href=this.value">
                                                    ...
                                                    <option value="{{ url('danhmuc') }}{{ $group_sp->id }}">Mặc định</option>
                                                    <option value="{{ url('danhmuc') }}{{ $group_sp->id }}/sapxep=giatangdan">Giá tăng dần</option>
                                                    <option value="{{ url('danhmuc') }}{{ $group_sp->id }}/sapxep=giagiamdan">Giá giảm dần</option>
                                                    @foreach ($event_pr as $event_pr)
                                                        @if ($event_pr->Event_SP != NULL)
                                                            <option value="{{ url('danhmuc') }}{{ $group_sp->id }}/sapxep={{ $event_pr->Event_SP }}">{{ $event_pr->Event_SP }}</option>
                                                        @endif
                                                    @endforeach
