                            ...
                            <div class="single-product">
                                ...
                                {{-- <form action="{{ url('/giohang') }}" method="post" class="actions-btn">
                                    ...
                                    <a href="{{ url('sanpham') }}{{$s_e_product->id}}" data-original-title="" title=""><i class="fa fa-eye"></i></a>
                                     @if ($s_e_product->Availability != "Hết Hàng")
                                        <input type="hidden" name="ID_SP" value="{{$s_e_product->id}}">
                                        <input type="hidden" name="Ten_SP" value="{{$s_e_product->Ten_SP}}">
                                        <input type="hidden" name="Gia_SP" value="{{$s_e_product->Gia_SP}}">
                                ...
                                @if($s_group_sp->id==$s_products->ID_Group)
                                    <div class="col-xs-12">
                                        <div class="single-product margin-bottom">
                                            ...
                                            {{-- <form action="{{ url('/giohang') }}" method="post" class="actions-btn">
                                                @csrf
                                                <a href="sanpham{{$s_products->id}}" data-original-title="" title=""><i class="fa fa-eye"></i></a>
                                                 @if ($s_products->Availability != "Hết Hàng")
                                                    <input type="hidden" name="ID_SP" value="{{$s_products->id}}">
                                                    <input type="hidden" name="Ten_SP" value="{{$s_products->Ten_SP}}">
                                                    <input type="hidden" name="Gia_SP" value="{{$s_products->Gia_SP}}">
                                                    <input type="hidden" name="qty" value="1">
                                                    <button type="submit" name="Buy"><i class="fa fa-shopping-cart"></i></button>
                                                @else
                                                    <button type="button"><i class="fa fa-sign-in" aria-hidden="true"></i></button>
